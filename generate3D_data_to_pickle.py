...
def gen_3d_volume(ct_array, pt_array, patch_size_h: int, patch_size_w: int, patch_size_d: int, pixel_spacing:int, ct_save_path, pt_save_path, start_num):
    '''
        ...
        for j in range(width_iter):
            for k in range(depth_iter):
                temp_ct_array = ct_array[0:, pixel_spacing * i:pixel_spacing * i + patch_size_h,
                                pixel_spacing * j:pixel_spacing * j + patch_size_w, pixel_spacing * k:pixel_spacing * k + patch_size_d, 0:]
                temp_pt_array = pt_array[0:, pixel_spacing * i:pixel_spacing * i + patch_size_h,
                                pixel_spacing * j:pixel_spacing * j + patch_size_w, pixel_spacing * k:pixel_spacing * k + patch_size_d, 0:]
...
def main():
    ...
    ct_save_path = r'E:\training data\3D volume(128+128)\ct volume'
    pt_save_path = r'E:\training data\3D volume(128+128)\pt volume'
